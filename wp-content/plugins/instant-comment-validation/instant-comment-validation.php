...
function instant_comment_validation_init() {
	...
	wp_enqueue_style( 'commentvalidation', plugins_url( 'assets/css/instant-comment-validation.css', __FILE__ ) ); //WP_PLUGIN_URL . '/instant-comment-validation/assets/css/instant-comment-validation.css'
	wp_enqueue_script('jqueryvalidate', plugins_url( 'assets/js/jquery.validate.min.js', __FILE__ ), array('jquery'));
	wp_enqueue_script('commentvalidation', plugins_url( 'assets/js/instant-comment-validation.js', __FILE__ ) , array('jquery','jqueryvalidate'));
	}
}
