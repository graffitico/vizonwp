...
<div class="frame-1 hidden-xs">
	<div class="row">
		...
		<div class="col-md-6 frame1-rightpane">
			<div class="row frame1-text">
				<a href="#shoppers"><h2 class="yellow-text text-center">Shoppers love apps</h2></a>
			</div>
			<div class="row frame1-text">
				<a href="#app-retarget"><h2 class="white-text text-center">App retargeting</h2></a>
			</div>
			<div class="row frame1-text">
				<a ref="#app-reengage"><h2 class="white-text text-center">App Re-engagement</h2></a>
			</div>
		</div>
	</div>
</div>
...
<div class="frame-5 white-text">
				...
				<tbody>
					<tr>
						...
						<td style="width: 50%;">
							...
							<p style="text-align:left" class="hidden-xs wow slideInUp">Did you know that just 1/4th of users access an app more than once after download? Long periods of inactivity leads to uninstalls. Segment these inactive users based on their idle periods and Re-engage them with personalised ads.</p>
						</td>
					</tr>
				</tbody>
			</table>
				...
				<tbody>
					<tr>
						<td  style="width: 50%;">
							...
							<p style="text-align:right" class="hidden-xs wow slideInUp">Connect with your app users, make sure they never leave. Our in-app algorithms helps us target the right audience segment based on the behavioral traits including inactive period, products seen, drop-off page, frequent visitors and many more.</p>
						</td>
	...
	<div class="row box-touch">
		<div class="col-lg-6 col-md-6 pull-right col-xs-12">
			<table>
				<tbody>
					<tr>
						...
						<td style="width: 50%;">
							...
							<p style="text-align:left" class="hidden-xs wow slideInUp">Irrespective of where your audience may be located, our mix of large global and specific local media networks will deliver your messages to them.</p>
						</td>
					</tr>
				</tbody>
			</table>
				...
				<tbody>
					<tr>
						<td style="width: 50%;">
							...
							<p style="text-align:right" class="hidden-xs wow slideInUp">You have over 1,000,000 downloads? Great! But do your customers buy through the app? Monetize your app from just a downloadable to a sales channel.</p>
						</td>
				...
				<tbody>
					<tr>
						...
						<td  style="width: 50%;">
							...
							<p style="text-align:left" class="hidden-xs wow slideInUp">Constantly interact with your users through personalized and value adding messages. Deliver seamless user experience, prevent uninstalls and expand your active user base.</p>
						</td>
					</tr>
				</tbody>
			</table>
				...
				<tbody>
					<tr>
						...
						<td style="width: 50%;">
							...
							<p style="text-align:left" class="hidden-xs wow slideInUp">Target high value users, use owned channels like push and app personalization to connect with them and optimize your reactivation spends.</p>
						</td>
					</tr>
				</tbody>
			</table>
    ...
    <div class="container frame-8">
        ...
        <div class="row">
			...
			<div class="col-md-4 blog-entry-tile">
                ...
                <p><b>Date:</b> September 12, 2014</p>
                <p>In a fragmented online ecosystem, a consistent and personalized customer experience is a prerequisite for marketers who are keen to foster engagement and build relationships with users.</p>
                <a href="/vizuryblog/mobile-remarketing-tips-to-engage-e-commerce-app-users/" target="_blank"><img  class="bottom-right" src="/images/read-more.svg" /></a>
            </div>
        </div>
    </div>
